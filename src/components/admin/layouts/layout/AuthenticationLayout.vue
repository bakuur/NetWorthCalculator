                    ...
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                        <div style="max-width: 25rem;">
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <a href="#" class="mr-2 text-muted"><i class="fa fa-facebook-square fa-lg"></i></a>
                                    <a href="#" class="mr-2 text-muted"><i class="fa fa-github-square fa-lg"></i></a>
                                    <a href="#" class="mr-2 text-muted"><i class="fa fa-linkedin-square fa-lg"></i></a>
                                    <a href="#" class="mr-2 text-muted"><i class="fa fa-twitter-square fa-lg"></i></a>
                                </div>
                                <div>
                                    <a href="#" class="mr-2 text-muted">Home</a>
                                    <a href="#" class="mr-2 text-muted">About Us</a>
                                    <a href="#" class="mr-2 text-muted">FAQs</a>
                                </div>
                            </div>
                        </div>
                    </div>
